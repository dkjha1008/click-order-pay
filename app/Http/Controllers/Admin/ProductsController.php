...
class ProductsController extends Controller
{
    ...
    public function create(){
		...
		$relatedProducts = Products::where('status','1')->pluck('title','id');
		...
		return view('admin.products.create', compact('title','category','stores','relatedProducts','attributes'));
	}
	...
	public function store(Request $request)
    {
        ...
        $store->related_products = implode(',',$request->related_products);
		$store->product_type = $request->product_type;
		// $store->sizes = $request->product_type === 'Variable' ? @implode(',',@$request->sizes):null;
		$store->save();
	...
	public function edit(Request $request, Products $product)
    {
		...
		$category = Category::where('status', '1')->where('is_delete', '0')->orderBy('id', 'desc')->pluck('name', 'id');
		return view('admin.products.edit', compact('title', 'product', 'category','stores','relatedProducts','attributes'));
    }
	...
	public function update(Request $request, Products $product)
    {
		...
		// $product->sizes = $request->product_type === 'Variable'? @implode(',',$request->sizes):null;
		$product->save();
