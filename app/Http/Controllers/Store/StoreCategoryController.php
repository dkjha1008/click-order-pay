...
class StoreCategoryController extends Controller
{
    ...
    public function index(Request $request){
		...
		$category = $category->where('store_id', auth()->user()->store->id);

		$category = $category->where('is_delete', '0')->orderBy('reorder', 'asc')->paginate(10);

		return view('store.category.index', compact('title', 'category'));
	}
    ...
    public function create(){
		...
		return view('store.category.create', compact('title'));
	}
	...
	public function edit(Request $request, Category $category)
    {
		...
		return view('store.category.edit', compact('title', 'category'));
    }
