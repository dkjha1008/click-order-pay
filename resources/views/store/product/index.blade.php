...
<div class="row">
	<div class="col-12">
		...
		<div class="box-body">
			...
			{!! Form::open(['route' => 'store.products', 'method'=>'get']) !!}
			<div class="row">
				...
				<div class="col-md-4 form-group">
					...
					<div class="form-group" style="float: right;">
						...
						<a class="btn btn-warning" href="{{ route('store.products.csvExport') }}">CSV Export</a>
					</div>
				</div>
		...
		<div class="card">
			<div class="card-header">
                ...
                <div class="card-tools pull-right">
					<a href="{{ route('store.products.create') }}" title="Add" class="btn btn-success btn-icon"><i class="fa fa-plus"></i></a>
				</div>
			</div>
                ...
                <table class="table table-hover text-nowrap">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								@if($j>1)
								<a href="{{ route('store.products.position', [$product->id, 'up']) }}">
									<i class="fa fa-arrow-up"></i>
								</a>
								@endif
								
								@if($j < $products->total())
								<a href="{{ route('store.products.position', [$product->id, 'down']) }}">
							...
							<td>
								<div class="btn-icon-list">
									<a href="{{ route('store.products.edit', $product->id) }}" class="btn btn-warning btn-icon">
										<i class="fa fa-edit"></i>
									</a>
									
									<a data-method="Delete" data-confirm="Are you sure?" href="{{ route('store.products.destroy', $product->id) }}" class="btn btn-danger btn-icon">
...
<div id="csvImport" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			{!! Form::open(['route' => 'store.products.csv', 'enctype' => 'multipart/form-data']) !!}
