	...
	<div class="col-12">
		<div class="box-body">
			...
			<div class="row">
				...
				<div class="col-md-2 form-group">
					...
					<a href="{{ route('admin.orders.csv') }}?user={{@request()->user}}&payment_type={{@request()->payment_type}}&status={{@request()->status}}&from_date={{@request()->from_date}}&to_date={{@request()->to_date}}" class="btn btn-success csv">CSV</a>
				</div>
			</div>
			{!! Form::close() !!}
		</div>
		...
		<div class="card">
			...
			<div class="card-body table-responsive p-0">
                @include('admin.orders.table', ['data'=>$orders])
			</div>
		</div>
