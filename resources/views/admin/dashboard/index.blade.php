...
<div class="alert alert-danger">
	<a href="{{ route('admin.products') }}?quantity={{@$settings->low_quantity}}"><strong>Alert</strong> You have {{ $products }} product{{ $products>1 ? 's' : '' }} with low quantity</a>
</div>
@endif
...
<div class="row">
	...
	<div class="col-12 col-sm-6 col-md-3">
		<div class="info-box">
			...
			<a href="{{ route('admin.orders') }}?status=1" class="info-box-content">
	...
	<div class="col-12 col-sm-6 col-md-3">
		<div class="info-box mb-3">
			...
			<a href="{{ route('admin.orders') }}" class="info-box-content">
	...
	<div class="col-12 col-sm-6 col-md-3">
		<div class="info-box mb-3">
			...
			<a href="{{ route('admin.users') }}" class="info-box-content">
                <span class="info-box-text">Total Members</span>
                <span class="info-box-number">{{ $latestUser }}</span>
			</a>
		</div>
	</div>
</div>
...
<div class="row">	
	...
	<div class="col-12 col-sm-6 col-md-3">
		<div class="info-box mb-3">
			...
			<a href="{{ route('admin.orders') }}?status=3" class="info-box-content">
	...
	<div class="col-12 col-sm-6 col-md-3">
		<div class="info-box mb-3">
			...
			<a href="{{ route('admin.dailysales') }}" class="info-box-content">
	...
	<div class="col-12 col-sm-6 col-md-3">
		<div class="info-box mb-3">
			...
			<a href="{{ route('admin.users') }}" class="info-box-content">
                ...
                <span class="info-box-number">{{ $dailyUser }}</span>
			</a>
		</div>
	</div>
</div>
