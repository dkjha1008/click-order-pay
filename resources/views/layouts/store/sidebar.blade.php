...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	<!-- Brand Logo -->
	<a href="{{ route('store') }}" class="brand-link">
	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
					<a href="{{ route('store') }}" class="nav-link {{ @$title['active']=='dashboard' ? 'active' : '' }}">
				...
				<li class="nav-item">
					<a href="{{ route('store.orders') }}" class="nav-link {{ @$title['active']=='orders' ? 'active' : '' }}">
				...
				<li class="nav-item">
					<a href="{{ route('store.attributes.index') }}" class="nav-link {{ @$title['active']=='attribute' ? 'active' : '' }}">
				...
				<li class="nav-item">
					<a href="{{ route('store.profile') }}" class="nav-link {{ @$title['active']=='profile' ? 'active' : '' }}">
