...
const Ucla = () => {
	...
	const [productSize, setProductSize] = useState({size:'',productId:''});
	...
	function addToCart(productId, store_id, product_type ) {

		console.log('click', productSize);
		// if(product_type=='Variable'){
		// 	if( productSize.productId != productId || productSize.size == '' || productSize.size == null){
																...
																<div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-6" key={k}>
																	<div className="products">
																		...
																		<div className="product-cntnt">
																			...
																			{product.product_type=='Variable' && attributes.length > 0 && attributes.map((attr, key) => {
																		...
																		<div className="add-to-cart">
																			...
																			{(storeHours && product.qty > 0) &&
																				<span onClick={() => addToCart(product.id, product.store_id, product.product_type)}>
						...
						<div className="product-popup-inner-wrapper">
							...
							<div className="product-popup-cntnt">
								...
								{(storeHours && productPopup.qty > 0) &&
									<button className="cart-btn pink-btn-design" onClick={() => addToCart(productPopup.id, productPopup.store_id, productPopup.product_type)}>Add To Cart</button>
								}
								{productPopup.qty == 0 &&
									<span className="out-stock">Out of Stock</span>
								}
